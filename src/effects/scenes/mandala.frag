...
uniform float u_rotspeedPhase;   // integral of u_rotspeed: rate, not rescaled history
uniform float u_suck;
uniform float u_suckPhase;   // integral of u_suck: rate, not rescaled history
